...
type MediaToCategory struct {
	...
	CategoryID uuid.UUID      `gorm:"column:category_id;primaryKey;type:uuid" json:"category_id"`
}

func (MediaToCategory) TableName() string {
	return "hta.media_to_category"
}
